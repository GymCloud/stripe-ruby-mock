  ...
  module RequestHandlers
    module Subscriptions
      ...
      def create_subscription(route, method_url, params, headers)
        ...
        allowed_params = %i(customer application_fee_percent coupon items metadata plan quantity source tax_percent trial_end trial_period_days trial_from_plan current_period_start created prorate billing_cycle_anchor billing days_until_due idempotency_key enable_incomplete_payments cancel_at_period_end default_tax_rates payment_behavior pending_invoice_item_interval default_payment_method collection_method transfer_data proration_behavior pay_immediately)
